...
void SpriteAnimado::cargarAnimaciones(string nombre){
	if(nombre == "CapitanAmerica" ){
		...
		Animacion *golpeS=new Animacion("golpeS",5,0,633,158,85,4);//golpe simple LISTO
		Animacion *patadaS=new Animacion("patadaS",4,1000,774,153,102,4);//patada simple LISTO
		...
		Animacion *golpeF=new Animacion("golpeF",8,900,608,151,145,4);//golpe fuerte LISTO
		Animacion *patadaF=new Animacion("patadaF",6,150,916,145,125,4);//patada fuerte LISTO
